...
import com.github.dio.mensageria.infra.gateways.OllamaHttpGateway;
...
class OllamaHttpGatewayIntegrationTest {
    ...
    void shouldGenerateValidPortugueseVariationPreservingCriticalData() throws Exception {
        ...
        String patientName = nomes.get(random.nextInt(1,100));
        String consultationDetails = consultas.get(random.nextInt(1,100));
        long startTime = System.currentTimeMillis();
        String firstResponse = ollamaGateway.gerarVariacaoMensagem(patientName, consultationDetails, LocalDateTime.now());
